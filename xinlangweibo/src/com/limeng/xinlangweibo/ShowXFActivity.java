...
public class ShowXFActivity extends Activity {
    
    private static final String TAG = "ShowXFActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        friend_lv.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                Intent intent = new Intent(ShowXFActivity.this, ShowDetailUser.class);
    ...
    private void getUsers(String uid) {
        ...
        friendshipsAPI.bilateral(Long.valueOf(uid), 50, 1, new RequestListener() {
