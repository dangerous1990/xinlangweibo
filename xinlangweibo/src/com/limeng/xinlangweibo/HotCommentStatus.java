 ...
 * @author limeng
 */
public class HotCommentStatus extends Activity {
    
    private static final String TAG = "HotCommentStatus";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        message_lv.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int positon, long id) {
                Intent intent = new Intent(HotCommentStatus.this, ShowDetailStatus.class);
        ...
        statusesAPI.favoritesHot(10, 1, new RequestListener() {
            ...
            public void onComplete(String buffer) {
                ...
                try {
                   ...
                   // JSONArray json_data = base_json.getJSONArray(buffer);
