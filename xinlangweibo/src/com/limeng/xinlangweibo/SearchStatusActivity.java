...
public class SearchStatusActivity extends Activity {
...
//                Intent intent = new Intent(SearchStatusActivity.this, SearchUserDetail.class);
...
//                startActivity(intent);
    ...
    private void getUsers(String name) {
        ...
        searchAPI.statuses(name, 10, new RequestListener() {
                ...
                try {
                    ...
                    for (int i = 0; i < base_json.length(); i++) {
                        ...
                        if (json_object != null) {
                            ...
                            user.setScreen_name(json_object.getString("suggestion"));
