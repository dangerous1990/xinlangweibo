...
public class SendCommentActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        share_button.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!InfoHelper.checkNetWork(SendCommentActivity.this)) {
                    Toast.makeText(SendCommentActivity.this, "网络连接失败，请检查网络设置！", Toast.LENGTH_LONG).show();
                } else {
                    if (isChecked()) {
                        dialog.show();
                        sendComments(contentEditText.getText().toString(), Long.valueOf(status.getId()), false);
                    }
                }
            }
        });
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what > 0) {
                Toast.makeText(SendCommentActivity.this, "发表评论成功", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(SendCommentActivity.this, "发表评论失败", Toast.LENGTH_SHORT).show();
            }
        }
    };
     ...
     * 发表评论
     */
    private void sendComments(String comment, long id, boolean isRelyOri) {
        ...
        commentsAPI.create(comment, id, isRelyOri, new RequestListener() {
